            ...
            <div class="card p-3 bg-white">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-12">
                        ...
                        @csrf  
                        <div class="mb-3">
                            <label for="text_username" class="form-label text-dark">Entre com o seu e-mail</label>
                        ...
                        <div class="mb-3">
                            <label for="text_password" class="form-label text-dark">Escolha uma senha</label>
                        ...
                        <div class="mb-3">
                            <button class="btn btn-secondary w-100 text-white" type="submit">Cadastrar-se</button>
                        </div>
                        </form>
                    </div>
                </div>
